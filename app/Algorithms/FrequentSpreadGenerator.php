...
final class FrequentSpreadGenerator implements ContextualNumberGenerator
{
    /** 후보 테이블 없이 한 번 읽은 당첨 이력만으로 결정적인 조합을 만듭니다. */
    public function __construct(private LottoDrawCalendar $calendar, private SpreadPlanner $planner) {}

    /** 시작 번호 선정과 궁합 동률 규칙의 버전을 고정합니다. */
    public function identifier(): string
    {
        return 'frequent-spread-v1';
    }
    ...
    {
        if ($count !== 5) {
            throw new InvalidArgumentException('frequent-spread-v1은 정확히 5게임만 생성합니다.');
        }
